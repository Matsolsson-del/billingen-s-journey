...
export const slides: SlideDef[] = [
  ...
  d(6, "Läget", "Akt 1", S05B, "Billingen ligger fem minuter från centrum, en timme från Göteborg och två från Stockholm. Närheten är en förutsättning – både för invånarnas vardag och för besökarens beslut."),
  d(7, "Modet", "Akt 2", S06, "288 miljoner är en stor offentlig investering. Besluten fattades långt innan gästnätter och rubriker kunde mätas. Tacka politiken över block- och mandatperioder – uthålligheten är själva poängen."),
  d(8, "Vad som byggdes", "Akt 2", S07, "Räkna inte upp allt. Visa tre rörelser: från väderberoende till mer snösäkerhet, från separata anläggningar till ett sammanhängande område och från säsong till året runt."),
  d(9, "Systemet", "Akt 2", S08, "Klicka fram helheten. Gästen möter inte våra organisationsgränser. Hon möter resan: ankomst, aktivitet, mat, boende och nästa anledning att komma tillbaka.", 2),
  d(10, "Dubbla nyttan", "Akt 2", S09, "Det här är inte turism eller invånarnytta. Samma investering kan ge barnets fritid, föreningens arena, företagens attraktionskraft och besökarens upplevelse."),
  ...
  d(12, "Kundresan", "Akt 3", S11, "Vi säljer inte elva kilometer konstsnö. Vi hjälper någon att klara sitt första Vasalopp. Det är skillnaden mellan att marknadsföra en anläggning och att utveckla en destination."),
  d(13, "Billingehus", "Akt 3", S12, "Kommunens investering gjorde platsen starkare. Lotus tog över 2022, öppnade hotellet 2023 och utvecklade spa och kongresskapacitet. Offentligt och privat började dra åt samma håll."),
