...
export function S11B() {
  return <Slide tone="ink">
    ...
    <div className="absolute inset-y-0 right-0 overflow-hidden w-[58%]"><Photo src={img.modernBuilding} alt="Billingehus efter totalrenoveringen" position="center 50%" /><div className="fade-r-ink absolute inset-0" /></div>
...
export function S15B() {
  return <Slide tone="ink">
    ...
    <div className="absolute inset-y-0 right-0 overflow-hidden w-[58%]"><Photo src={img.billingetrollet} alt="Billingetrollet" position="center 40%" /><div className="fade-r-ink absolute inset-0" /></div>
    <div className="absolute top-1/2 left-24 w-[860px] -translate-y-1/2">
      ...
      <div className="anim-rise d5 mt-14 flex items-end gap-8">
        <span className="slide-title-lg text-bill-teal" style={{fontSize:"132px",lineHeight:1,whiteSpace:"nowrap"}}>2 700</span>
